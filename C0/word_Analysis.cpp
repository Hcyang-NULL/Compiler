...
void add_token(){
    if(s == OK){
        cout << now << " ";
        switch(iden){
            case HEX:cout << "十六进制数" << endl;break;
            case DEC:cout << "十进制数" << endl;break;
            case OCT:cout << "八进制数" << endl;break;
            case BIN:cout << "二进制数" << endl;break;
            case BOUND:cout << "界符" << endl;break;
            case STR:cout << "字符串常量" << endl;break;
            case CHAR:cout << "字符常量" << endl;break;
            case TAG:{
                if(now == "auto"){
                    iden = KW_AUTO;
                }
